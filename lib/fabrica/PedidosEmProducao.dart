...
class PedidosEmProducao extends StatefulWidget {
  @override
  _PedidosEmProducaoState createState() => _PedidosEmProducaoState();
}

class _PedidosEmProducaoState extends State<PedidosEmProducao> {
  ...
  Stream<QuerySnapshot> _recuperarListenerPedidos() {
    final stream = db
        ...
        .where("status", isEqualTo: StatusPedido.PRODUCAO)
        .snapshots();
          ...
          case ConnectionState.done:
            if (snapshot.hasError) {
              ...
              if (querySnapshot.documents.length == 0) {
                return Center(
                  child: Text(
                    "Não existe(m) pedido(s) cadastrado(s) em Produção.",
