...
class ConfirmarAtualizarPedidoFabrica extends StatefulWidget {
  ...
  ConfirmarAtualizarPedidoFabrica(this.solicitarPedido, this.idUsuario, this.produto);

  @override
  _ConfirmarAtualizarPedidoFabricaState createState() => _ConfirmarAtualizarPedidoFabricaState(solicitarPedido, idUsuario, produto);
}
...
class _ConfirmarAtualizarPedidoFabricaState extends State<ConfirmarAtualizarPedidoFabrica> {
  ...
  _ConfirmarAtualizarPedidoFabricaState(this.solicitarPedido, this.idUsuario, this.produto);
