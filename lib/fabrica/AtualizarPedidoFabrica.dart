...
class AtualizarPedidoFabrica extends StatefulWidget {
  ...
  AtualizarPedidoFabrica(this.solicitarPedido,  this.idUsuarioLogado);

  @override
  State <AtualizarPedidoFabrica> createState() {
    return _AtualizarPedidoFabricaState(
...
class _AtualizarPedidoFabricaState extends State<AtualizarPedidoFabrica> {
  ...
  _AtualizarPedidoFabricaState(this.solicitarPedido, this.idUsuarioLogado)
      : super();
    ...
    if(!isEqual(solicitarPedido)){
      if(solicitarPedido.Textura_Acrilica  == '0'    && solicitarPedido.Grafiato_Acrilico == '0'
        ...
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) =>
                ConfirmarAtualizarPedidoFabrica(solicitarPedido, idUsuario, produto)));
      }
    }else{
      _showIsEqual();
    }
